...
namespace game::scene {
	...
	void GameScene::testResourceManager() {
		...
		mUIManager->addElement(std::make_unique<engine::ui::UILabel>(
			mContext.getTextRenderer(),
			"Hello, World!",
	...
	void GameScene::testECS() {
		...
		// 变换、速度、精灵组件
		mRegistry.emplace<engine::component::TransformComponent>(entity, glm::vec2(100, 100));
		mRegistry.emplace<engine::component::VelocityComponent>(entity, glm::vec2(5, 10));
		mRegistry.emplace<engine::component::SpriteComponent>(entity, engine::component::Sprite("assets/textures/Units/Archer.png", engine::utils::Rect(0, 0, 192, 192)));
		...
		mRegistry.emplace<engine::component::AnimationComponent>(entity, std::move(animation_map), "idle"_hs);
	}
