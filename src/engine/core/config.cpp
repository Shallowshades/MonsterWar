...
namespace engine::core {
	...
	void Config::fromJson(const nlohmann::json& data) {
		...
		if (data.contains("window")) {
			...
			mWindowScale = windowConfig.value("window_scale", mWindowScale);
			mWindowLogicalScale = windowConfig.value("logical_scale", mWindowLogicalScale);
		...
		return nlohmann::ordered_json{
			{
				"window", {
					...
					{ "window_scale", mWindowScale },
					{ "logical_scale", mWindowLogicalScale },
